...
def main():
    ...
    require("orbitalSpeeds" in body, "homepage galaxy stars must rotate at radius-relative speeds")
    require("scrollRotation" in body, "homepage galaxy must keep rotating with scroll context")
    require("initialTiltX" in body and "initialTiltZ" in body, "homepage galaxy must start from tilted classic-galaxy view")
    require("targetTiltX" in body and "targetYawY" in body, "homepage mouse must control up/down tilt and left/right yaw")
    ...
    require("createStarburst" in body, "homepage click must trigger zoom/starburst animation")
